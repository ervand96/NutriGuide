...
const sampleProducts: Product[] = [
  {
    ...
    price: "$32",
    description:
      "High-quality whey protein that keeps you full and helps preserve muscle while losing fat. 21g protein per serving with minimal calories.",
    pros: [
    ...
    affiliateUrl:
      "https://www.myprotein.com/referrals.list?applyCode=ERVAND-R5",
  ...
  },
  {
    ...
    price: "$18",
    description:
      "Natural appetite suppressant studied to reduce cravings. Best used alongside a balanced diet and exercise routine.",
  ...
  },
  {
    ...
    price: "$70/mo",
    description:
      "Psychology-based weight loss with real human coaches. Targets the habits and mindset behind overeating — not just calories.",
    ...
    <div className="bg-white border-2 border-gray-100 rounded-2xl p-7 relative mt-6">
      ...
      <div className="mt-2">
        <div className="flex justify-between items-start flex-wrap gap-2 mb-2">
          ...
          <span className="font-bold text-xl text-leaf-500">
            {product.price}
          </span>
        </div>
        ...
        <div className="flex gap-8 mb-6 flex-wrap">
          <div>
            <div className="text-xs font-bold text-leaf-500 uppercase tracking-widest mb-2">
              ✅ Pros
            </div>
            {product.pros.map((p) => (
              <div key={p} className="text-sm text-gray-600 mb-1">
                • {p}
              </div>
            ))}
          </div>
          <div>
            ...
            {product.cons.map((c) => (
              <div key={c} className="text-sm text-gray-600 mb-1">
                • {c}
              </div>
            ))}
          </div>
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-8 font-body">
          With thousands of weight loss supplements on the market, it's almost
          impossible to know which ones are worth your money. We spent 3 months
          testing and researching the most popular options. Here are the ones
